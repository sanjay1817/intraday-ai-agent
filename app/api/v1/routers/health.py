...
- `/health`: a general status snapshot for humans/dashboards/monitoring
  (app identity, environment, uptime) — informational, not itself a
  pass/fail probe like the two above.
"""
...
def health(
    ...
    """A general status snapshot: app identity, environment, and uptime."""
